...
const VERTICAL_INPUT_WIDTH =
  Dimensions.get("window").width - CARD_NUMBER_INPUT_WIDTH_OFFSET; // https://github.com/yannickcr/eslint-plugin-react/issues/106
      ...
      <View style={s.container}>
        ...
        >
          <CCInput
            ...
            containerStyle={[
              verticalInput ? s.verticalInputContainer : s.inputContainer,
              inputContainerStyle,
              {
                width: verticalInput
                  ? VERTICAL_INPUT_WIDTH
                  : CARD_NUMBER_INPUT_WIDTH,
              },
            ]}
          />
          <CCInput
          ...
          {requiresCVC && (
            <CCInput
              ...
              containerStyle={[
                ...
                inputContainerStyle,
                {
                  width: verticalInput ? VERTICAL_INPUT_WIDTH : CVC_INPUT_WIDTH,
                },
              ]}
            />
          )}
